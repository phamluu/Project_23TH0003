...
{
    public class QuanLyHocPhanDbContext: DbContext
    {
        public QuanLyHocPhanDbContext(DbContextOptions<QuanLyHocPhanDbContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Lop>(entity =>
            {
                entity.ToTable("Lop");
                entity.HasKey(e => e.Id);
                entity.HasOne(e => e.Khoa).WithMany(e => e.Lops).HasForeignKey(e => e.IdKhoa).OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<MonHoc>(entity =>
            {
                ...
                entity.HasKey(e => e.Id);
                entity.HasOne(e => e.Khoa).WithMany(e => e.MonHocs).HasForeignKey(e => e.IdKhoa).OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Diem>(entity =>
            {
                entity.ToTable("Diem");
                entity.HasKey(e => e.Id);
                entity.HasOne(e => e.DangKyHocPhan).WithOne(e => e.Diem).HasForeignKey<Diem>(e => e.IdDangKyHocPhan).OnDelete(DeleteBehavior.Restrict);
