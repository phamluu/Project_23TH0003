...
{
    public class Diem_23TH0003Controller : Controller
    {
        ...
        // GET: XemDiem_23TH0003Controller/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: XemDiem_23TH0003Controller/Create
        [HttpPost]
        ...
        // GET: XemDiem_23TH0003Controller/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: XemDiem_23TH0003Controller/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
